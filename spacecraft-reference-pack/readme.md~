...
Becasue there is no Level 2 implementation, this application will not run. It is provided as a reference of the structure of an application using the multiple mode pattern.
