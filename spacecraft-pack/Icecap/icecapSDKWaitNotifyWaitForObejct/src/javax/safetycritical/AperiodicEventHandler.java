...
/**
 * This class permits the explicit release of application code. Concrete subclasses must implement the <code>handleAsyncEvent</code> method and may
 * override the default <code>cleanUp</code> method. <br>
 * 
...
public abstract class AperiodicEventHandler extends ManagedEventHandler {
	 ...
	 * 
	 * @param priority
	 *            is the priority parameters for this aperiodic event handler; it must not be null.
	 * @param release
	 *            is the release parameters for this aperiodic event handler; it must not be null.
	 * @param storage
	 *            is the <code>StorageParameters</code> for this aperiodic event handler.
	 * 
	...
	public AperiodicEventHandler(PriorityParameters priority, AperiodicParameters release, StorageParameters storage, String name) {
