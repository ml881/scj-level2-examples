 ...
 * <p>
 * This class is final. It is instantiated by the infrastructure and entered by the infrastructure. Hence, non of its constructors are
 * visible.
 * 
...
final class MissionMemory extends ManagedMemory {
	Runnable runInitialize;
	Runnable runExecute;
	Runnable runCleanup;
	Mission m;

	MissionMemory(int size, ManagedMemory backingStoreProvider) {
