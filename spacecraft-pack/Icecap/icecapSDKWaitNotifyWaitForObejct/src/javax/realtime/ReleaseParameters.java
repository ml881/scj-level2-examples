 ...
 * Although the RTSJ allows on-line schedulability analysis, SCJ assumes any such analysis is performed off line and that the on-line environment is
 * predictable. Consequently, the assumption is that deadlines are not missed. <br>
 ...
 * 
 * @scjComment - implementation issue: the following public method is not in SCJ; it is used in an JML annotation: <br>
 *             <ul>
 *             <code> <li>public RelativeTime getDeadline(); </code>
 *             </ul>
 */
@SCJAllowed
public abstract class ReleaseParameters implements Cloneable {
	...
	/*
	 * @ // The non-negative deadline is not checked in the code, should it? public invariant deadline != null ==> ( getDeadline().getMilliseconds()
	 * >= 0L && 0 <= getDeadline().getNanoseconds() );
	 * 
	 * @
	 */
	 ...
	 * There is no default for deadline in this class. The default is set by the subclasses.
	 */
	/*
	 * @ protected behaviour requires true; ensures getDeadline() == null && getMissHandler() == null;
	 * 
	 * @
	 */
	 ...
	 * 
	 * @param deadline
	 *            is the deadline to be checked. It is cloned to become immutable.
	 * @param missHandler
	 *            is the event handler to be released if the deadline is missed.
	 */
	/*
	 * @ protected behaviour requires true;
	 * 
	 * ensures (deadline != null) ==> getDeadline().equals(deadline); ensures deadline == null ==> getDeadline() == null; ensures getMissHandler() ==
	 * missHandler;
	 * 
	 * @
	 */
