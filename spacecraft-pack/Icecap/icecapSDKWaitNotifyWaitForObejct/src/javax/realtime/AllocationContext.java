...
/**
 * All memory allocation takes places from within an allocation context. This interface defines the operations available on all allocation contexts.
 ...
 * 
 * @scjComment - semantic issue: Why is this interface introduced as a public entity? No applications declare or access memory areas?
 */
...
public interface AllocationContext {
	 ...
	 */
	/*
	 * @ public behavior requires true; ensures \result >= 0;
	 * 
	 * @
	 */
	@SCJAllowed
	 ...
	 */
	/*
	 * @ public behavior requires true; ensures \result >= 0; ensures \result == memoryRemaining()+ memoryConsumed();
	 * 
	 * @
	 */
	@SCJAllowed
