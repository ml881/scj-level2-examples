...
public class RealtimeClock extends Clock {
	...
	/*
	 * @ public behaviour requires true; assignable \nothing; ensures \result.equals(new RelativeTime(0, 0, this));
	 * 
	 * @
	 */
	@Override
	...
	/**
	 * Returns a newly allocated RelativeTime object that indicates the nominal interval between ticks. The return value shall be associated with this
	 * clock. All relative time differences measured by this clock are approximately an integral multiple of the resolution.
	 * 
	 * @return clock resolution.
	 */
	/*
	 * @ public behaviour requires true; assignable \nothing; ensures \result.equals(new RelativeTime(resolution));
	 * 
	 * @
	 */
	@Override
	...
	/*
	 * @ public behaviour requires true; //assignable \nothing; //ensures \result != null; //ensures (dest == null) || dest.equals(\result);
	 * 
	 * @
	 */
	@Override
